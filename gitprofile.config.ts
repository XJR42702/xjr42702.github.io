...
const CONFIG = {
  github: {
    username: 'xjr42702', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  seo: {
    title: 'Portfolio of Xochitl Ramirez',
    description: '',
    imageURL: '',
  },
  social: {
    linkedin: 'xochitlramirez02',
    x: '',
    mastodon: '',
    researchGate: '',
    facebook: '',
    ...
    skype: '',
    telegram: '',
    website: 'https://xjr42702.github.io',
    phone: '',
  ...
  education: [
    ...
    },
    {
      ...
      degree: 'AA Social & Behavioral Sciencess',
      from: '2020',
      to: '2022',
    },
  ],
